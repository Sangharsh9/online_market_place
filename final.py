...
def sell_product():
    ...
    session_total_final_price = 0

    while True:
        display_products()
        product = input("Enter product name (or type 'done' to finish shopping): ")
        if product.lower() == 'done':
            print(f"Thank you for shopping with us. Your total to pay is: ${session_total_final_price:.2f}")
            break
        ...
        session_total_final_price += final_price
